...
<h1>关键字:<s:property value="keyword" /></h1>
...
<s:url action="TitleSearchAction" namespace="/search" var="previewURL" >
    <s:param name="currentPage"><s:property value="previewPage" /></s:param>
    <s:param name="keyword"><s:property value="keyword" /></s:param>
</s:url>
<s:url action="TitleSearchAction" namespace="/search" var="nextURL" >
...
<div class="pagination">
    <ul>
        ...
        <s:iterator value="showPages" status="status">
            ...
            <s:url action="ITitleSearchAction" namespace="/search" var="pageURL" >
