...
<head>
    ...
    <link href="style/random_image_stream.css" rel="stylesheet" media="screen" />
</head>
<body>
...
<s:url action="ImageRankStreamAction" namespace="/stream/image" var="previewURL" >
    <s:param name="currentPage"><s:property value="previewPage" /></s:param>
    <s:param name="streamType"><s:property value="streamType" /></s:param>
</s:url>
<s:url action="ImageRankStreamAction" namespace="/stream/image" var="nextURL" >
...
<div class="pagination">
    <ul>
        ...
        <s:iterator value="showPages" status="status">
            ...
            <s:url action="ImageRankStreamAction" namespace="/stream/image" var="pageURL" >
